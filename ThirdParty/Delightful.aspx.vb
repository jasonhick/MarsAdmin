...
Partial Class Delightful
    ...
    Protected Sub btnEmailOrders_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnEmailOrders.Click
        ...
        orders = orderAdapter.GetSelectedOrders(StatusDropDownList.SelectedValue, 126, str2)
        ...
        msg.To = "enquiries@delightfulliving.co.uk"
        ...
        For Each row As ThirdPartyOrdersRow In orders
            ...
            msgBody.AppendLine("<h3 style='margin-bottom:5px'>GIFT MESSAGE:</h3>")
            msgBody.AppendLine(row.Message)

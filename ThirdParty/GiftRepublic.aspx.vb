...
Partial Class GiftRepublic
    ...
    Protected Sub BtnExportGrid_Click(ByVal sender As Object, ByVal args As EventArgs)
        ...
        GridView1.DataBind()
        Dim path As String
        path = Server.MapPath("~/ThirdParty/GiftRepublic/GR-" & Date.Now.ToString("yyyyMMdd-HHmmtt") & ".xls")
    ...
    Sub EmailExcelFile(ByVal excelFilePath As String)
        ...
        msgBody.AppendLine("Sent to:<br>orders@giftrepublic.com<br><b>PLEASE NOTE:<br>This email has been automatically generated.<br>Contact us immediately on 020 3239 1996 if you have any problems reading it.</b>")
        ...
        msg.Subject = "New GR Orders - " & Date.Now.ToString("dd/MM/yyyy HH:mm tt")

...
Partial Class Intervino2
    ...
    Protected Sub BtnExportGrid_Click(ByVal sender As Object, ByVal args As EventArgs)
        ...
        GridView1.DataBind()
        Dim path As String
        path = Server.MapPath("~/ThirdParty/Intervino/NAPIV-" & Date.Now.ToString("yyyyMMdd-HHmmtt") & ".xls")
    ...
    Sub EmailExcelFile(ByVal excelFilePath As String)
        ...
        msgBody.AppendLine("Sent to:<br>dan@intervino.co.uk,holly@intervino.co.uk,steve@intervino.co.uk<br><b>PLEASE NOTE:<br>This email has been automatically generated.<br>Contact us immediately if you have any problems reading it.</b>")
        ...
        msg.Subject = "New IV Orders - " & Date.Now.ToString("dd/MM/yyyy HH:mm tt")

<%@ Page Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" EnableEventValidation="true" CodeFile="GourmetPizza.aspx.vb" Inherits="GourmetPizza" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="content-box-header">
	    ...
	    <div class="align-left"><h3>Gourmet Pizza Orders</h3></div>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Product">
                <ItemTemplate><%# Eval("ProductName")%><%# CheckEmptyString(Eval("SupplierSKU"))%></ItemTemplate>
            </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" 
        ...
        <SelectParameters> 
            ...
            <asp:Parameter Name="SupplierID" DefaultValue="137" />
        </SelectParameters>
    </asp:SqlDataSource>

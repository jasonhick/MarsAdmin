<%@ Page Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="InThePaper.aspx.vb" Inherits="InThePaper" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="content-box-header">
	    ...
	    <div class="align-left"><h3>In The Paper Orders</h3></div>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" 
        ...
        <SelectParameters> 
            ...
            <asp:Parameter Name="SupplierID" DefaultValue="132" />
        </SelectParameters>
    </asp:SqlDataSource>

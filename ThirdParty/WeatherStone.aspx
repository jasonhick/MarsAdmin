<%@ Page Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="WeatherStone.aspx.vb" Inherits="WeatherStone" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="content-box-header">
	    ...
	    <div class="align-left"><h3>Weather Stone Orders</h3></div>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" 
        ...
        <SelectParameters> 
            ...
            <asp:Parameter Name="SupplierID" DefaultValue="131" />
        </SelectParameters>
    </asp:SqlDataSource>

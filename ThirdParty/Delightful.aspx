<%@ Page Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="Delightful.aspx.vb" Inherits="Delightful" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="content-box-header">
	    ...
	    <div class="align-left"><h3>Delightful Orders - Plaques</h3></div>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" 
        ...
        <SelectParameters> 
            ...
            <asp:Parameter Name="SupplierID" DefaultValue="126" />
        </SelectParameters>
    </asp:SqlDataSource>
